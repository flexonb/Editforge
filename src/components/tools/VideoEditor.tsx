    ...
    <div className="h-full flex flex-col bg-gradient-to-br from-white/90 via-purple-50/80 to-teal-50/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-xl">
      ...
      <div className="flex items-center justify-between p-6 border-b border-white/20 bg-gradient-to-r from-purple-500/10 to-teal-500/10">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Export buttons - always visible when video is loaded */}
          {hasVideoLoaded && (
            <div className="flex items-center space-x-2">
              <button
                onClick={exportFrame}
                className="flex items-center space-x-2 px-4 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white rounded-xl transition-all transform hover:scale-105 shadow-lg"
              >
                <Download className="w-4 h-4" />
                <span className="font-medium">Export Frame</span>
              </button>
              
              <button
                onClick={exportVideo}
                className="flex items-center space-x-2 px-4 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl transition-all transform hover:scale-105 shadow-lg"
              >
                <Download className="w-4 h-4" />
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-3 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white rounded-xl transition-all transform hover:scale-105 shadow-lg"
              >
                <Download className="w-4 h-4" />
